    ...
    401: {
      ...
      content: {
        'application/json': {
          schema: {
            message:
              'You are not authorized to perform this action. Please make sure you are logged in',
          },
        },
      },
    },
    ...
    403: {
      ...
      content: {
        'application/json': {
          schema: {
            message:
              'You are not allowed to perform this action. Only sellers can interact with notifications',
          },
        },
      },
    },
...
export { getAll, getUnread, readAll, readSingle, deleteSingle };
