...
var components = {
  schemas: {
    ...
    id: {
      type: 'number',
      description: 'ID for different modals including products, users, orders, roles,wishlist, etc.',
      example: 1
    },
    // QUANTITY
    quantity: {
    ...
    token: {
      ...
      example: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6Im5pc2hpbXdlc3dhZ2dlcmFnYWluQGdtYWlsLmNvbSIsImlhdCI6MTY4MDI1Mzc1MiwiZXhwIjoxNjgwODU4NTUyfQ.2jVpZ8XB_3ra4vukc8NkdI2aZcTiEoJIzheAsA-fM5U'
    },
    // STRING
    string: {
      type: 'string',
    ...
    name: {
      type: 'string',
      description: 'Name of models used in the application, including user, product, category, etc.',
    ...
    totalPrice: {
      type: 'number',
      description: ' total price of a product containing more quantity in the cart',
      example: 10000
    },
    // NUMBER
    number: {
    ...
    requestSubscriptionResponse: {
      ...
      properties: {
        ...
        isSubscribed: {
          type: 'boolean',
          description: 'Status of the subscription, always false until a user confirms their subscription via email',
          example: false
        },
        // CREATEDAT
        createdAt: {
      ...
      properties: {
        ...
        card: {
          ...
          properties: {
            number: {
              type: 'integer',
              description: 'Card number. Use the example provided (Stripe testing card) for testing purposes.',
              example: 4242424242424242
            },
            // EXPIRY MONTH
            exp_month: {
              type: 'number',
              description: 'Card expiry month. Use any month of your choice for testing',
              example: 12
            },
            // EXPIRY YEAR
            exp_year: {
